...
uschar *recipient_verify_failure_log_message = NULL;
uschar *recipient_verify_failure_user_message = NULL;
...
uschar *sender_verify_failure_log_message = NULL;
uschar *sender_verify_failure_user_message = NULL;
